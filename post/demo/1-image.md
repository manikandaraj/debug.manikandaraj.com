...
Thanks for [liwenyip/hugo-easy-gallery](https://github.com/liwenyip/hugo-easy-gallery) & [Zebradil · Pull Request #48](https://github.com/manikandaraj/mango/pull/48) .

Now, we could use `{{</* gallery */>}}` shortcode in mango.
